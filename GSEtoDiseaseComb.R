<<<<<<< HEAD
#this function takes as input a GSE (i.e GSE5343)
#and returns a character vector with 
#diseases separated by ;

#THIS CODE NEEDS MUCH CLEANING

GSEtoDiseaseComb<-function(GSE){
  ...
  annot<-get(load("E:/Dropbox (MXM - UoC)/Documents/Data-Based IR/Paper Experiments/Annotation/diseasesLevelALLUnique2.Rda"))
  #unlist all xs per disease
