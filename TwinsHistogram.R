...
if ( i %in% c(50,100,150,200,250,300,350,400)){
  save(ranksPALL, file="E:/Dropbox (MXM - UoC)/Paper - Landscape of Human Dataome - 2017/Results/ranksPALL.Rda")
  save(ranksQALL, file="E:/Dropbox (MXM - UoC)/Paper - Landscape of Human Dataome - 2017/Results/ranksQALL.Rda")
}
