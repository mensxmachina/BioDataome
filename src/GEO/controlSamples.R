#this function receives as input a data frame with the contents of series matrix
#this could be the output of downloadPhenotypePlatform function
#and returns a data frame of GEO sample ids (i.e. GSM60555) and their class.
#Their class consists of sample characterization as control or unknown.
