...
write.table(KLs, file="E:/Dropbox (MXM - UoC)/Paper - Landscape of Human Dataome - 2017/Results/GPL13534-117ALLdatasets-similarity-graph.txt",
            sep="\t",row.names = F, col.names = T)

save(KLs,file="E:/Dropbox (MXM - UoC)/Paper - Landscape of Human Dataome - 2017/Results/GPL13534-117ALLdatasets-similarity-graph.Rda" )
