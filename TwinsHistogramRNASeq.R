...
print(i)
  ...
  save(ranksPALL, file="E:/Dropbox (MXM - UoC)/Paper - Landscape of Human Dataome - 2017/Results/ranksPALLRNASeq.Rda")
  save(ranksQALL, file="E:/Dropbox (MXM - UoC)/Paper - Landscape of Human Dataome - 2017/Results/ranksQALLRNASeq.Rda")
#}
